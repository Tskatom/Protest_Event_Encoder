...
In this settings, we have following limitations:
    1> the positive bags should have no more than k portion of the doc
    2> the chossen high quality sentences should share some properties
"""
