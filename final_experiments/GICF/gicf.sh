...
pretrained_fn=../../data/100d_vectors_w2v.txt
...
do
    ...
    python $model_exe --prefix ../../data/new_multi_label/${i}/event --sufix event_cat --word2vec $vec_trained_fn --event_fn ../../data/event_cat.dic --option ${param_fn} --exp_name $exp_name
done
