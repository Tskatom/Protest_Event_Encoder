...
def test_mlp(log_name, prefix, sufix, dic_fn, learning_rate=0.1, L1_reg=0.000, L2_reg=0.0001, n_epochs=4000, batch_size=50, n_hidden=50, n_out=2):
    """
...
def parse_args():
    ...
    ap.add_argument("--sufix", type=str, default="sent_cat")
...
def main():
    ...
    prefix_format = "./data/noRats/%d/Imdb_review"
    prefix = prefix_format % args.fold
    sufix = args.sufix
    dict_fn = args.dict_fn
    n_out = args.n_out
    log_name = "mlp_sent_fold_%s_%d.log" % (sufix, args.fold)
