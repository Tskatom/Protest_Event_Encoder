...
s_es_file = "../data/single_label_nog/spanish_protest.txt.tok"
s_en_file = "../data/single_label_nog/english_protest.txt.tok"
s_pop_file = "../data/single_label_nog/pop_label.txt"
s_type_file = "../data/single_label_nog/eventType_label.txt"
