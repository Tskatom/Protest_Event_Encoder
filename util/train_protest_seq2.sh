  ...
  mem=8   # pre-allocate 4GB device memory 
  gpumem=${gpu}:${mem}
  ...
  max_num=30000
  vocab_fn=data/spanish_protest_trn-${max_num}.vocab
  ...
  log_fn=log_output/spanish-protest-seq2.log
  perf_fn=perf/spanish-protest-seq2-perf.csv
  echo 
  ...
  $cnn_exe $gpumem cnn \
         ...
         data_dir=data trnname=spanish_protest_train- tstname=spanish_protest_test- \
