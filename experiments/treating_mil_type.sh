...
exp_name=treating_mil_type_w${word_dm}_d25
log_fn=./log/${exp_name}.log
perf_fn=./results/
param_fn=./mil_type_param.json
python $model_exe --prefix ../data/treating_single_label/spanish_protest --sufix type_cat --word2vec $vec_trained_fn --dict_fn ../data/type_cat.dic --max_sens 30 --max_words 70 --padding 3 --exp_name $exp_name --max_iter 75 --batch_size 100 --log_fn $log_fn --perf_fn $perf_fn --param_fn $param_fn 
