...
exp_name=word_pop_l2_d50
log_fn=./log/${exp_name}.log
perf_fn=./results/
param_fn=./pop_l2_param.json
python $model_exe --prefix ../data/single_label/spanish_protest --sufix pop_cat --word2vec $vec_trained_fn --dict_fn ../data/pop_cat.dic --max_len 2000 --padding 3 --exp_name $exp_name --max_iter 100 --batch_size 100 --log_fn $log_fn --perf_fn $perf_fn --param_fn $param_fn
