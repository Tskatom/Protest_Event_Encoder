...
exp_name=MLT_cnn_d500
log_fn=./log/${exp_name}.log
perf_fn=./results/
param_fn=./param.json
python $model_exe --prefix ../data/single_label/spanish_protest --sufix_pop pop_cat --sufix_type type_cat --word2vec $vec_trained_fn --dict_pop_fn ../data/pop_cat.dic --dict_type_fn ../data/type_cat.dic --max_len 2000 --padding 3 --exp_name $exp_name --max_iter 100 --batch_size 100 --log_fn $log_fn --perf_fn $perf_fn --param_fn $param_fn
